...
FixStyle(doubles/bond/break,FixDoublesBondBreak)

#else

#ifndef LMP_DOUBLES_FIX_BOND_BREAK_H
#define LMP_DOUBLES_FIX_BOND_BREAK_H

#include "fix.h"

namespace LAMMPS_NS {

class FixDoublesBondBreak : public Fix {
 public:
  FixDoublesBondBreak(class LAMMPS *, int, char **);
  ~FixDoublesBondBreak();
  int setmask();
  void init();
  void post_integrate();
 ...
 private:
  int me,nprocs;
  int btype,seed;
  double cutoff,cutoff_min,cutsq,cutsq_min,fraction;
